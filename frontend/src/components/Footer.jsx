        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-200 hover:text-white transition-colors block py-1">Home</Link></li>
              <li><Link to="/about" className="text-gray-200 hover:text-white transition-colors block py-1">About Us</Link></li>
              <li><Link to="/apply" className="text-gray-200 hover:text-white transition-colors block py-1">Apply for Bursary</Link></li>
              <li><Link to="/contact" className="text-gray-200 hover:text-white transition-colors block py-1">Contact Us</Link></li>
            </ul>
          </div>

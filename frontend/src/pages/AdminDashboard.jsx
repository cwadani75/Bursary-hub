                ...
                reports.map((report) => (
                  <tr key={report.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300">
                    <td className="px-6 py-4">
                      <div>
                        <div className="text-sm font-semibold text-gray-900 dark:text-white">{report.title}</div>
                    ...
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <div className="text-xs text-gray-600 dark:text-gray-400">{report.reporter_email}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-xs text-gray-600 dark:text-gray-400">
                        <div><strong>County:</strong> {report.county || 'N/A'}</div>
                        <div><strong>Sub-County:</strong> {report.sub_county || 'N/A'}</div>
                        <div><strong>Ward:</strong> {report.ward || 'N/A'}</div>
                        <div><strong>Village:</strong> {report.village || 'N/A'}</div>
                      </div>
                    </td>
